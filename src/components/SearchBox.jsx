    ...
    return (
        <div className="flex flex-col">
            <div className="flex justify-center w-full">
                <input type="text" name="book-search" id="book-search" className=" bg-slate-200 h-10 w-2/6 border-solid border-2 border-black p-2 font-semibold rounded-t-md max-[426px]:w-3/6" value={data} onChange={(e) => OnChange(e.target.value)} placeholder="Search Your Book" />
